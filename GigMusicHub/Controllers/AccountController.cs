    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if(ModelState.IsValid)
            {
                ...
                {
                    //Don't reveal that the user doean not exist or is not confirmed
       ...
       //GET/Account//ResetPassword Confrimation
        ...
        #region Helpers
        //Used for XSRF key when adding external Login
